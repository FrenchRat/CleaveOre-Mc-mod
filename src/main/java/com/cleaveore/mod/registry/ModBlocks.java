...
public final class ModBlocks {
    ...
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(CleaveOreMod.MOD_ID);
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(CleaveOreMod.MOD_ID);
