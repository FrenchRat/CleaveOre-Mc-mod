...
import com.veinmine.mod.block.HollowOreShellBlock;
...
public class ModBlocks {
    ...
    private static Block register(String name, boolean deepslate) {
        ...
        Identifier id = new Identifier(VeinMineMod.MOD_ID, name);
    ...
    /** Called from VeinMineMod.onInitialize() to trigger static field initialization. */
    public static void register() {
        VeinMineMod.LOGGER.info("Registering VeinMine blocks...");
    }
}
